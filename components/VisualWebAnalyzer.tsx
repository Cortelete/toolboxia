...
const VisualWebAnalyzer: React.FC = () => {
    ...
    const handleDescribe = useCallback(async () => {
        ...
        try {
            ...
            const textPart = {
                text: `Aja como um designer UI/UX expert e analista de marketing digital. Analise a seguinte imagem, que é uma captura de tela de um site ou aplicativo. Forneça uma análise detalhada e construtiva. Organize sua resposta usando markdown com títulos e listas, começando cada título com '###'. As seções devem ser:
                
                ### 🎯 Propósito Principal e Clareza
                - Qual parece ser o objetivo principal desta página?
                - A proposta de valor é clara e imediata para um novo visitante?
                
                ### 🎨 Design e Apelo Visual
                - Como você descreveria o layout e a estrutura?
                - Avalie a paleta de cores, tipografia e o uso de espaço em branco.
                - Os elementos visuais (ícones, imagens) são de alta qualidade e relevantes?
                
                ### ✨ Experiência do Usuário (UX)
                - A navegação parece ser intuitiva?
                - Os CTAs (Call to Actions) são claros e bem posicionados?
                - A página parece sobrecarregada ou limpa e focada?
                
                ### 📝 Conteúdo e Tom de Voz
                - O texto é legível e conciso?
                - Qual é o tom de voz transmitido (ex: profissional, amigável, técnico)?
                
                ### 🚀 Pontos de Melhoria
                - Liste 2-3 sugestões concretas para melhorar o design e a UX desta página.`,
            };
                    ...
                    {description && (
                        <div className="bg-gray-50/70 dark:bg-gray-900/70 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                             <div className="flex justify-between items-center mb-4">
                                <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200">Análise da IA</h2>
                                <button
                                    onClick={handleCopy}
                             ...
                             <div className="text-gray-700 dark:text-gray-300 space-y-4">
                                {description.split('### ').filter(s => s.trim()).map((section, index) => {
                                     ...
                                     return (
                                         <div key={index}>
                                             ...
                                             <div className="whitespace-pre-wrap pl-3 mt-2 border-l-4 border-sky-500/70 text-gray-600 dark:text-gray-400">
                                                {content}
                                             </div>
                                         </div>
                                     );
